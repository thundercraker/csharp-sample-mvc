...
namespace EngineerTest.Services
{
    public class CryptowatchRepository
    {
        ...
        /// <param name="limit">Maximum amount of entities to take</param>
        public virtual async Task<IList<CryptoTrade>> GetAllTrades(
            TimeSpan timePeriod,
            int limit = 10000)
        {
        ...
        /// <param name="timePeriod">The timespan since UtcNow to retreive trades from</param>
        /// <param name="limit">Maximum amount of items to take</param>
